...
Proof.
intros g l H1 H2.
assert (H3: length ([] :: l) >=2 \/ length ([] :: l) < 2) by lia.
...
Proof.
intros g l H1 H2.
assert (H5: length l > 2 \/ length l = 2) by lia.
...
- destruct IH as [l0 [H4 [H5 H6]]].
  ...
  assert (H30: length l0 > 1 \/ length l0 <= 1) by lia.
  ...
  + (* length l0 > 1 *)
    ...
    * apply not_eq_sym.
      ...
      exact H30.
  + assert (H50: length l0 = 1 \/ length l0 = 0) by lia.
...
- destruct H4 as [s1' [s1'' [s2' [s2'' [beta [H5 [H6 H7]]]]]]].
  ...
  assert (H8':=H8).
  assert (H20: length l0 >= 2 \/ length l0 < 2) by lia.
  ...
  + apply sflist_split in H8.
    * destruct H8 as [s0 [s3 [l' [H11 [H12 H13]]]]].
      ...
      exact H8'.
    * exact H20.
  + assert (H21: length l0 = 1 \/ length l0 = 0) by lia.
